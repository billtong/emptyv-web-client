...
class VideoPage extends React.Component {
    ...
    onSubmit(e) {
        ...
        const me = this;
        postComment.postComment(inputJson, sessionStorage.getItem('emptyVideoLoginToken'), sessionStorage.getItem('emptyVideoLoginSessionId')).then((res)=>{
    ...
    render() {
        ...
        const upload_date = formatDateTime(parseInt(videoData.videoDate));
