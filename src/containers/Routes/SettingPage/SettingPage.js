        ...
        return (
            <div>
                <ul className="setting-ul">
                    ...
                    <li className="setting-li">
                        <div>name</div>
                        <input className={"input-text"} placeholder={getSessionTokenJson().user.profile.name}
                               type={"text"}
                    ...
                    <li className="setting-li">
                        <div>Location</div>
                        <input className="input-text" placeholder={getSessionTokenJson().user.profile.location}
                               type="text"
                    ...
                    <li className="setting-li">
                        ...
                        <input className="input-text" placeholder={getSessionTokenJson().user.profile.website}
                               type="text"
